<form id="jobform" action="<?php echo URL::site(Route::get('post')->uri()) ?>#formerrors" method="post">
	<h2><?php echo __('Post a new job') ?></h2>
...
<?php endif ?>
	...
	<fieldset>
		...
		<p>
			...
			<input id="company" name="company" type="text" value="<?php echo HTML::chars($defaults['company']) ?>" maxlength="100" size="30" />
		...
		<p>
			...
			<input id="location" name="location" type="text" value="<?php echo HTML::chars($defaults['location']) ?>" maxlength="100" size="30" />
			<samp<?php echo __('>Example: “Miami, FL” or “Paris, France”') ?></samp>
		</p>

		<p>
			<label for="website"><?php echo __('Website') ?></label>
			<input id="website" name="website" type="text" value="<?php echo HTML::chars($defaults['website']) ?>" maxlength="100" size="30" />
			<samp><?php echo __('Example: “http://www.kohanaphp.com/”') ?></samp>
		</p>

		<p>
			<label for="email"><?php echo __('E-mail') ?><abbr title="required">*</abbr></label>
			<input id="email" name="email" type="text" value="<?php echo HTML::chars($defaults['email']) ?>" maxlength="100" size="30" />
	...
	<fieldset>
		...
		<p>
			...
			<input id="title" name="title" type="text" value="<?php echo HTML::chars($defaults['title']) ?>" maxlength="100" size="50" />
		...
		<p>
			...
			<textarea id="description" name="description" cols="50" rows="10"><?php echo HTML::chars($defaults['title']) ?></textarea>
		...
		<p>
			...
			<input id="apply" name="apply" type="text" value="<?php echo HTML::chars($defaults['apply']) ?>" maxlength="200" size="50" />
